...
createChannel "fruitsprovider"
createChannel "fruitsreceiver"

joinChannel "peer0.buttercup.example.com" "fruitsprovider" "ButtercupMSP" 1
joinChannel "peer1.buttercup.example.com" "fruitsprovider" "ButtercupMSP" 0
joinChannel "peer0.popstar.example.com" "fruitsprovider" "PopstarMSP" 1
joinChannel "peer1.popstar.example.com" "fruitsprovider" "PopstarMSP" 0

joinChannel "peer0.buttercup.example.com" "fruitsreceiver" "ButtercupMSP" 1
joinChannel "peer1.buttercup.example.com" "fruitsreceiver" "ButtercupMSP" 0
joinChannel "peer0.popstar.example.com" "fruitsreceiver" "PopstarMSP" 1
joinChannel "peer1.popstar.example.com" "fruitsreceiver" "PopstarMSP" 0

packageChaincode "trace_fruits_cc" "golang" "${CHAINCODE_VERSION}"

# Install chaincode onto peers. Do not worry about channels here.
installChaincode "peer0.buttercup.example.com" "trace_fruits_cc" "ButtercupMSP" "${CHAINCODE_VERSION}"
installChaincode "peer1.buttercup.example.com" "trace_fruits_cc" "ButtercupMSP" "${CHAINCODE_VERSION}"
installChaincode "peer0.popstar.example.com" "trace_fruits_cc" "PopstarMSP" "${CHAINCODE_VERSION}"
installChaincode "peer1.popstar.example.com" "trace_fruits_cc" "PopstarMSP" "${CHAINCODE_VERSION}"

# Instantiate chaincode on each channel.
instantiateChaincode "peer0.buttercup.example.com" "fruitsprovider" "trace_fruits_cc" "ButtercupMSP" "${CHAINCODE_VERSION}"
instantiateChaincode "peer0.buttercup.example.com" "fruitsreceiver" "trace_fruits_cc" "ButtercupMSP" "${CHAINCODE_VERSION}"


# These set up channel logging to Splunk
curl -X PUT fabric-logger.example.com:8080/channels/fruitsprovider
curl -X PUT fabric-logger.example.com:8080/channels/fruitsreceiver
